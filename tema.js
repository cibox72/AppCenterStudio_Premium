...
(function(){
 ...
 function apply(t){
  ...
  var css=
   'body{background:linear-gradient(180deg,'+th.sf1+' 0%,'+th.sf2+' 100%) !important; background-attachment:fixed !important;}'+
   ...
   '.btn,.btn-primary,.tab.active,.badge,.topbar button:hover,.topbar .pill:hover,.bb-btn.main,.bp{background-color:'+th.acc+' !important;border-color:'+th.acc+' !important;color:#fff !important}'+
   '.btn-secondary,.mini,.btn-link,.topbar button,.topbar .pill,.bs{border-color:'+th.acc+' !important;color:'+th.scuro+' !important; background-color:'+th.carta+' !important;}'+
   '.btn-secondary:hover,.mini:hover,.btn-link:hover,.bs:hover{background-color:'+th.acc+' !important;color:#fff !important}'+
  ...
  var od=document.getElementById('appTemaDeco');if(od)old.remove();
 }
